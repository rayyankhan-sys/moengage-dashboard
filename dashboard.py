...
Clean flow: Pick dates ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Pull Data ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ View ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Export
"""
import json
import base64
import logging
...
st.set_page_config(
    page_title="MoEngage Dashboard ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Aspora",
...
def safe_div(numerator, denominator, as_pct=False):
    """Safe division ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ returns None if denominator is 0 or None"""
...
def page_dashboard():
    """Main dashboard page"""
    st.title("ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ MoEngage Comms Dashboard")
    st.caption("Aspora ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ UK & UAE Communications Metrics")
    ...
    # ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Auto-Import from Bookmarklet ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    qp = st.experimental_get_query_params()
    ...
    # ==================================================================
    # TOP CONTROL BAR ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Date Pickers + Actions
    # ==================================================================
    st.markdown("---")
    ...
    with btn_col1:
        pull_clicked = st.button(
            "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Pull Data",
            key="pull_data",
    ...
    with btn_col2:
        export_clicked = st.button(
            "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¥ Export Report",
            key="export_report",
            use_container_width=True,
        )
    ...
    with btn_col3:
        dry_run_clicked = st.button(
            "ÃÂÃÂ°ÃÂÃÂÃÂÃÂ§ÃÂÃÂª Dry Run",
            key="dry_run",
            use_container_width=True,
    ...
    if pull_clicked:
        ...
        with st.spinner("Pulling data from MoEngage..."):
            try:
                ...
                if err_count == 0:
                    st.success(
                        f"Pull complete ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ {seg_count} segments, {camp_count} campaigns "
                        f"in {total_time:.1f}s"
                    )
                else:
                    st.warning(
                        f"Pull complete with {err_count} error(s) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ "
    ...
    if dry_run_clicked:
        with st.spinner("Running dry run..."):
            try:
                ...
                st.info(
                    f"Dry run complete ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ would create {len(summary.get('segments', {}))} segments. "
    ...
    if st.session_state.report_bytes:
        st.download_button(
            label="ÃÂÃÂ¢ÃÂÃÂ¬ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ Download Weekly Report (.xlsx)",
    ...
    # ==================================================================
    # TABS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Metrics, Comparison, Campaigns, Pull History, Settings
    # ==================================================================
    tab1, tab2, tab3, tab4, tab5 = st.tabs(
        ["ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Metrics", "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Comparison", "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Campaigns", "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Pull History", "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ Settings"]
    )
    ...
    with tab1:
        if not segment_metrics:
            ...
            # --- UK SECTION ---
            st.subheader("ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¬ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ§ United Kingdom")
            _render_country_metrics("GB", seg, campaign_metrics)

            st.markdown("---")

            # --- UAE SECTION ---
            st.subheader("ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¦ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂª United Arab Emirates")
...
def _render_country_metrics(
    ...
    # ==================================================================
    # RAW DATA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ User Base
    # ==================================================================
    st.markdown('<div class="section-header">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¦ RAW DATA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ User Base</div>', unsafe_allow_html=True)
    ...
    # ==================================================================
    # RAW DATA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Segment Counts
    # ==================================================================
    st.markdown('<div class="section-header">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¦ RAW DATA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Segment Counts</div>', unsafe_allow_html=True)
    ...
    with c6:
        st.metric("Unsub Rate ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Push", fmt_num(unsub_push))
    ...
    # ==================================================================
    # RAW DATA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Promotional & Transactional
    # ==================================================================
    st.markdown('<div class="section-header">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¦ RAW DATA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Campaign Metrics</div>', unsafe_allow_html=True)
    ...
    # ==================================================================
    # COMPUTED METRICS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Reachability & Reach
    # ==================================================================
    st.markdown('<div class="section-header">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ COMPUTED METRICS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Reachability & Reach</div>', unsafe_allow_html=True)
    ...
    c1, c2, c3, c4, c5, c6 = st.columns(6)
    with c1:
        st.metric("Comms Reachable (% Total) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Push", fmt_pct(push_reachable_pct))
    with c2:
        st.metric("Comms Reachable (% Total) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Email", fmt_pct(email_reachable_pct))
    with c3:
        st.metric("Comms Reached (% Total) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Push", fmt_pct(push_reached_pct))
    with c4:
        st.metric("Comms Reached (% Total) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Email", fmt_pct(email_reached_pct))
    with c5:
        st.metric("Comms Reachable (% Active) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Push", fmt_pct(push_reachable_active_pct))
    with c6:
        st.metric("Comms Reachable (% Active) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Email", fmt_pct(email_reachable_active_pct))

    # ==================================================================
    # COMPUTED METRICS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Unsubscribes
    # ==================================================================
    st.markdown('<div class="section-header">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ COMPUTED METRICS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Unsubscribe Rates</div>', unsafe_allow_html=True)
    ...
    c1, c2 = st.columns(2)
    with c1:
        st.metric("Unsubscribe Rate ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Push", fmt_pct(unsub_rate_push))
    with c2:
        st.metric("Unsubscribe Rate ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Email", fmt_pct(unsub_rate_email))

    # ==================================================================
    # COMPUTED METRICS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Est. Promo Push Sent
    # ==================================================================
    st.markdown('<div class="section-header">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ COMPUTED METRICS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Estimated Promo Push Sent</div>', unsafe_allow_html=True)
    ...
    # ==================================================================
    # COMPUTED METRICS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Avg Comms per User
    # ==================================================================
    st.markdown('<div class="section-header">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ COMPUTED METRICS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Avg Comms per User</div>', unsafe_allow_html=True)
    ...
    with c1:
        val_str = f"{avg_promo_push_per_user:.2f}" if avg_promo_push_per_user else "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ"
        st.metric("Avg Promo Comms per User ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Push", val_str)
    with c2:
        val_str = f"{avg_promo_email_per_user:.2f}" if avg_promo_email_per_user else "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ"
        st.metric("Avg Promo Comms per User ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Email", val_str)
    with c3:
        val_str = f"{avg_txn_push_per_user:.2f}" if avg_txn_push_per_user else "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ"
        st.metric("Avg Txn Comms per User ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Push", val_str)
    with c4:
        val_str = f"{avg_txn_email_per_user:.2f}" if avg_txn_email_per_user else "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ"
        st.metric("Avg Txn Comms per User ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Email", val_str)

    # ==================================================================
    # COMPUTED METRICS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Performance (Promotional)
    # ==================================================================
    st.markdown('<div class="section-header">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ COMPUTED METRICS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Performance (Promotional)</div>', unsafe_allow_html=True)
    ...
    # ==================================================================
    # COMPUTED METRICS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ PNs & Emails per Reachable User
    # ==================================================================
    st.markdown('<div class="section-header">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ COMPUTED METRICS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Comms per Reachable User</div>', unsafe_allow_html=True)
    ...
    c1, c2 = st.columns(2)
    with c1:
        val_str = f"{pns_per_reachable:.2f}" if pns_per_reachable else "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ"
        st.metric("PNs per Push Reachable User", val_str)
    with c2:
        val_str = f"{emails_per_reachable:.2f}" if emails_per_reachable else "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ"
...
def _render_comparison_tab(db):
    ...
    with load_col:
        load_comp = st.button(
            "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Load Comparison",
            key="load_comparison",
            use_container_width=True,
            type="primary",
        )
    ...
    if "comp_seg_a" in st.session_state:
        ...
        # UK Comparison
        st.subheader("ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¬ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ§ United Kingdom ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Comparison")
        _render_comparison_country("GB", seg_a, seg_b, camp_a, camp_b, period_a_label, period_b_label)

        st.markdown("---")

        # UAE Comparison
        st.subheader("ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¦ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂª United Arab Emirates ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Comparison")
...
def _render_comparison_country(
    ...
    with c3:
        ...
        st.metric("Change", fmt_pct(change) if change else "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ")
    ...
    # ==================================================================
    # RAW DATA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Campaign Metrics
    # ==================================================================
    st.markdown('<div class="section-header">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¦ RAW DATA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Campaign Metrics</div>', unsafe_allow_html=True)
    ...
    # ==================================================================
    # COMPUTED METRICS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Reachability (sample)
    # ==================================================================
    st.markdown('<div class="section-header">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ COMPUTED METRICS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Reachability & Performance</div>', unsafe_allow_html=True)
    ...
    c1, c2, c3, c4 = st.columns(4)
    with c1:
        st.metric("Comms Reached (%) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Push", fmt_pct(push_reached_pct_a))
    with c2:
        st.metric("Comms Reached (%) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Push", fmt_pct(push_reached_pct_b))
    with c3:
        change = safe_div(safe_sub(push_reached_pct_a, push_reached_pct_b), 1, as_pct=False)
        change_str = f"{change:+.2f}pp" if change else "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ"
    ...
    c1, c2, c3, c4 = st.columns(4)
    with c1:
        st.metric("Comms Reached (%) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Email", fmt_pct(email_reached_pct_a))
    with c2:
        st.metric("Comms Reached (%) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Email", fmt_pct(email_reached_pct_b))
    with c3:
...
def _render_settings(db):
    ...
    if txn_campaigns:
        for i, campaign in enumerate(txn_campaigns):
            ...
            with col_id:
                st.text(campaign.get("campaign_id", "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ"))
            with col_name:
                st.text(campaign.get("campaign_name", "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ"))
            with col_ch:
                st.text(campaign.get("channel", "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ"))
            with col_ctry:
                st.text(campaign.get("country", "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ"))
            with col_remove:
                if st.button("ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ", key=f"rm_{i}"):
                    txn_campaigns.pop(i)
    ...
    if st.button("ÃÂÃÂ°ÃÂÃÂÃÂÃÂ©ÃÂÃÂº Run Preflight Check", use_container_width=False):
        with st.spinner("Running preflight diagnostics..."):
            try:
                ...
                for check in results.get("checks", []):
                    ...
                    if status == "PASS":
                        st.success(f"ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ {name}")
                    elif status == "FAIL":
                        st.error(f"ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ {name}: {check.get('message', '')}")
                    elif status == "SKIP":
                        st.info(f"ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ {name} (skipped)")
    ...
    if st.button("ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ Clear All Data", use_container_width=False):
    ...
    # ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Manual Entry for User-Count Metrics ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    st.markdown("---")
    ...
    # ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ One-Click Auto-Fetch Bookmarklet ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    st.markdown("---")
    ...
    if bk_submitted:
        ...
        st.info(
            ...
            "5. Click the bookmark ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ it will fetch all counts and redirect here"
        )
