...
def page_dashboard():
 ...
 st.download_button(
 label="¢¬¯¸ Download Weekly Report (.xlsx)",
 ...
 ["° Metrics", "° Comparison", "° Campaigns", "° Pull History", "¢¯¸ Settings"]
 )
...
def _render_comparison_tab(db):
 ...
 # UAE Comparison
 st.subheader("°¦°ª United Arab Emirates ¢ Comparison")
...
def _render_settings(db):
 ...
 if st.button("°©º Run Preflight Check", use_container_width=False):
 ...
 if st.button("°¯¸ Clear All Data", use_container_width=False):
